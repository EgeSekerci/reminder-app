...
const ReminderDetails = ({ reminder }) => {
    ...
    return (
        <div className="max-w-m mb-4 mx-2">
            <span className="block w-full p-6 bg-white border border-gray-200 text-[var(--primary-dark)] rounded-lg shadow hover:bg-gray-100 dark:bg-[var(--secondary-dark)] dark:border-zinc-800 dark:hover:bg-zinc-800">
